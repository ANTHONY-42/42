...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/17 14:42:57 by anturtsc          #+#    #+#             */
/*   Updated: 2025/03/17 20:10:27 by anturtsc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (stack_b->size)
	{
		...
		if (index == max || index == (max - 1))
		{
			...
			if (stack_a->start->index == max)
				max--;
			if (stack_a->size > 1 && (stack_a->start->index)
				> (stack_a->start->next->index))
			{
				sa(stack_a);
				max--;
			}
...
void	k_sort(t_stack *stack_a, t_stack *stack_b)
{
	...
	pa_max(stack_a, stack_b, index, max);
}
